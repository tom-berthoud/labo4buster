...
\begin{itemize}
    ...
    émission d'un message de type~1 (\texttt{0x080 + adresse}) si leur valeur
    a changé ; si DIP8~=~1, lecture des 4~entrées analogiques et émission
    d'un message de type~0 (\texttt{0x000 + adresse}) si au
...
\begin{table}[H]
\centering
\begin{tabular}{|l|p{4cm}|p{6.2cm}|}
\hline
Registre & Masque & Filtre(s) \\
\hline
RXB0 (digital) & \texttt{0x7FF} (tous les bits comparés) &
\texttt{RXF0}=\texttt{RXF1}=\texttt{0x080 | rxAddress} \\
\hline
