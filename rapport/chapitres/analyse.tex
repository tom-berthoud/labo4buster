...
\hline
0000 & \texttt{0x000} + adresse (7 bits) & 4 valeurs analogiques codées sur 16 bits
...
Un message n'est émis que si les valeurs associées ont \emph{changé} depuis
le dernier envoi, ce qui limite le trafic sur le bus.
